2023-10-21T13:11:04.784Z [log] [ManagerDrivers] [Driver:vehicle] [Device:2c749ed7-59db-4342-8684-e4df96f8c1cb] {
  id: 1493122360811777,
  user_id: 693159,
  vehicle_id: 192325368320,
  vin: '5YJ3E7EB3MF953648',
  color: null,
  access_type: 'OWNER',
  granular_access: { hide_private: false },
  tokens: [ 'be1135b01409b782', '7a7844f67bfbe31e' ],
  state: 'online',
  in_service: false,
  id_s: '1493122360811777',
  ...
  charge_state: {
    ...
    est_battery_range: 162.1,
    fast_charger_brand: '<invalid>',
    fast_charger_present: false,
    fast_charger_type: 'MCSingleWireCAN',
    ideal_battery_range: 200.42,
    max_range_charge_counter: 0,
    minutes_to_full_charge: 920,
    ...
    time_to_full_charge: 15.33,
    timestamp: 1697893864658,
    trip_charging: false,
  ...
  drive_state: {
    ...
    gps_as_of: 1697893584,
    heading: 225,
    latitude: 55.704044,
    longitude: 13.210518,
    native_latitude: 55.704044,
    native_location_supported: 1,
    native_longitude: 13.210518,
    native_type: 'wgs',
    power: 0,
    shift_state: null,
    speed: null,
  ...
  vehicle_state: {
    ...
    car_version: '2023.32.9 757be7f0a072',
    ...
    media_info: {
      ...
      now_playing_station: 'Ingen enhet ansluten',
      now_playing_title: ''
    },
    media_state: { remote_control_enabled: true },
    notifications_supported: true,
    odometer: 16982.88203,
    ...
    tpms_last_seen_pressure_time_fl: 1697802812,
    tpms_last_seen_pressure_time_fr: 1697802842,
    tpms_last_seen_pressure_time_rl: 1697802842,
    tpms_last_seen_pressure_time_rr: 1697802812,
    tpms_pressure_fl: 2.7,
    tpms_pressure_fr: 2.7,
    tpms_pressure_rl: 2.7,
    tpms_pressure_rr: 2.575,
    tpms_rcp_front_value: 2.9,
    tpms_rcp_rear_value: 2.9,
    tpms_soft_warning_fl: true,
    tpms_soft_warning_fr: true,
